    ...
    def _add_route_paths(self, api, app):
        ...
        for path, view in app.routes.items():
            ...
            for http_method in view.methods:
                ...
                # TODO fix authorizer / security scaffolding
